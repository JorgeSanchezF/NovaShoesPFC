...
<body>
    ...
    <main>
        <a class="inicio" href='inicio.php'>Iniciar sesión</a>
        <a class="inicio" href="register.php">Registrarse</a>
        ...
        <form action="#" method="post">
            ...
            <label class="input-label">Contraseña:
                <input type="password" id="input" class="input-field" name="contra" onblur=validarPasswd() required><br>
                <span></span>
            </label>

            <label class="input-label">Correo:
                <input type="email" id="input" name="clase" class="input-field" placeholder="ejemplo@ejemplo.com" onblur=validarCorreo() required><br>
                <span></span>
            </label>
            <button class="button" onclick=//mensajeRegister()>Registrarse</button>
        </form>
    </main>
    <footer>
        <section>
