        ...
        <table class="tabla-cesta">
                ...
                <tbody>
                    ...
                    foreach ($resultado as $row) {
                        ...
                        echo '<tr>';
                        echo '<td class="celda-imagen"><img class="imagen-cesta" src="IMAGENES/' . $row['nombreProducto'] . '.png" class="img-card"></td>';
                        echo '<td>' . $row['nombreProducto'] . '</td>';
                        echo '<td>' . $row['precioProducto'] . '€</td>';
                        echo "<td><a class='boton-eliminar' href='delete.php?id=" . $row['idProducto'] . "'>Eliminar</a></td>";
                        echo '</tr>';
                    }
            ...
            <?php
            echo '<div class="precio-total">PRECIO TOTAL: ' . Database::sumarPrecio() . ' €</div>';
            ?>
    </main>
    <footer>
        <section>
